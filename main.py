...
def main(args, logger):
    ...
    loss = TverskyLoss(alpha=0.5, beta=0.6, weight=[1.31999035, 0.22905115, 0.14352195, 3.33210966, 0.11385707, 0.46669956, 0.31655025, 3.01568879, 2.07179101, 0.80488164, 5.08536677, 7.23954242], ignore_index=0)
    loss.cuda()
    model.cuda()
